...
const createDefaultTables = (): void => {
    ...
    dbConnection.query(
        'CREATE TABLE IF NOT EXISTS data_aixformation (name VARCHAR(8) NOT NULL, data LONGTEXT NOT NULL, UNIQUE KEY unique_name (name)) ENGINE = InnoDB DEFAULT CHARSET=utf8;');
    dbConnection.query(
